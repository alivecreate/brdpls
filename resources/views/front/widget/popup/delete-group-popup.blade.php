...
<div class="hidden lg:p-20 uk- open" id="confirm-delete-popup" uk-modal>
    <div class="uk-modal-dialog tt relative overflow-hidden mx-auto bg-white shadow-xl rounded-lg md:w-[520px] w-full dark:bg-dark2">
        ...
        <form class="needs-validation data-form" action="{{ route('group.destroy', $group->id) }} " method="POST" enctype="multipart/form-data">
            @csrf
            @method('DELETE')
            <div class="space-y-5 mt-3 p-2">
                ...
                <div class="flex justify-center items-center p-4 h-full">
                    <p class="text-center">Are you sure you want to delete this group?</p>
                </div>              
              </div>
