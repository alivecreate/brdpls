        ...
        <div  tabindex="-1" uk-slider="finite:true">
            ...
            <ul class="uk-slider-items grid-small">
                <li class="sm:w-1/3 w-1/2">
                    <div class="card">
                        <a href="{{route('timeline-funding')}}">
                            <div class="card-media h-32">
                                <img src="{{asset('front')}}/images/funding/funder-4.jpg" alt="">
                ...
                <li class="sm:w-1/3 w-1/2">
                    <div class="card">
                        <a href="{{route('timeline-funding')}}">
                            <div class="card-media h-32">
                                <img src="{{asset('front')}}/images/funding/funder-2.jpg" alt="">
                                <div class="card-overly"></div>
                            </div>
                        </a>
                        <div class="card-body">
                ...
                <li class="sm:w-1/3 w-1/2">
                    <div class="card">
                        <a href="{{route('timeline-funding')}}">
                            <div class="card-media h-32">
                                <img src="{{asset('front')}}/images/funding/funder-3.jpg" alt="">
                                <div class="card-overly"></div>
                            </div>
                        </a>
                        <div class="card-body">
        ...
        <div class="box p-5 mt-6">
            ...
            <div class="card-list">
                ...
                <div class="card-list-body">
                    <a href="{{route('timeline-funding')}}"> <h3  class="card-list-title"> Naveen's Boston Marathon & Charles River Marathon  </h3> </a>
            ...
            <div class="card-list">
                ...
                <div class="card-list-body">
                    <a href="{{route('timeline-funding')}}"> <h3  class="card-list-title">  Striding for a Cure for Cystic Fibrosis   </h3> </a>
                    <div class="card-list-text">
                        <p> consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, </p>
                    </div>
                    <div class="mt-3">
            ...
            <div class="card-list">
                ...
                <div class="card-list-body">
                    <a href="{{route('timeline-funding')}}"> <h3  class="card-list-title">  John's fundraiser for Hug It Forward.</h3> </a>
                    <div class="card-list-text">
                        <p> consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, </p>
                    </div>
                    <div class="mt-3">
        ...
        <div  class="lg:space-y-6 space-y-4 lg:pb-8 max-lg:grid sm:grid-cols-2 max-lg:gap-6" 
            ...
            <div class="box overflow-hidden">
                ...
                <div class="w-full h-24 relative">
                    <img src="{{asset('front')}}/images/funding/funder-1.jpg" alt="" class="w-full h-full absolute object-cover">
                </div>
