        ...
        {{-- <form method="#" action="#" class="space-y-7 text-sm text-black font-medium dark:text-white"  uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true"> --}}
          ...
          <div class="grid grid-cols-2 gap-4 gap-y-7">
            ...
            <div class="col-span-2">
                ...
                <div class="mt-2.5">
                  <input id="phone" name="phone" type="tel"
                    value="{{old('phone')}}"
                   placeholder="Phone No." required class="w-full rounded-lg bg-transparent shadow-sm border border-slate-200 dark:border-slate-800 dark:bg-white/5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <input id="password" name="password_confirmation" type="password" placeholder="***"  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5">  
                </div>
            </div>
