     <div id="site__sidebar"
         class="bg-white fixed top-0 left-0 z-[99] pt-[--m-top] overflow-hidden transition-transform xl:duration-500 max-xl:w-full max-xl:-translate-x-full">

         <!-- sidebar inner -->
         <div
             class="p-2 mt-10 max-xl:bg-white shadow-sm 2xl:w-60 sm:w-64 w-[80%] h-[calc(100vh-64px)] relative z-30 max-lg:border-r dark:max-xl:!bg-slate-700 dark:border-slate-700">
                         ...
                         <li class="mybusiness uk-parent">
                             <a href="{{route('myBusiness')}}" class="group">
                                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     ...
                                     <path stroke-linecap="round" stroke-linejbusiness.bladeoin="round"
                             ...
                             <ul class="my-1 space-y-0 text-sm">
                                 ...
                                 <li id="{{$business->id}}"><a href="{{route('myBusiness.show',$business->slug)}}"
