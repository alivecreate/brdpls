            ...
            <div class="flex flex-col justify-center -mt-20">
                ...
                <div class="relative h-20 w-20 mb-4 z-10">
                    <div class="relative overflow-hidden rounded-full md:border-[2px] border-gray-100 shrink-0 dark:border-slate-900 shadow">
                        <img src="{{asset('front')}}/images/group/group-avature.jpg" alt="" class="h-full w-full object-cover inset-0">                           
                    </div>
                </div>
        ...
        <div class="lg:w-[400px]"> 
            ...
            <div class="lg:space-y-4 lg:pb-8 max-lg:grid sm:grid-cols-2 max-lg:gap-6" 
                ...
                <div class="box p-5 px-6 space-y-4">
                    ...
                    <div class="side-list-item">
                        <a href="{{route('timeline')}}">
                            <img src="{{asset('front')}}/images/avatars/avatar-7.jpg" alt="" class="side-list-image rounded-full">
                        </a>
                        <div class="flex-1">
                            <a href="{{route('timeline')}}"><h4 class="side-list-title">  Maria Gray</h4></a>
                            <div class="side-list-info">Turkey </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex space-x-5 mt-5">
                            <div class="w-28 max-h-ful l h-20 flex-shrink-0 rounded-lg relative"> 
                                <img src="{{asset('front')}}/images/funding/funder-3.jpg" class="absolute w-full h-full inset-0 rounded-lg object-cover" alt="">
                            </div>
                            <div class="flex-1">
                                <a href="{{route('groupDetail')}}" class="font-medium capitalize line-clamp-2 text-black text-sm dark:text-white"> Naveen's Boston Marathon Charles River Marathon </a>
