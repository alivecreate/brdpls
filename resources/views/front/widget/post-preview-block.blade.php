        ...
        <div class="uk-modal-dialog tt relative mx-auto overflow-hidden shadow-xl rounded-lg lg:flex items-center ax-w-[86rem] w-full lg:h-[80vh]">
            ...
            <div class="lg:h-full lg:w-[calc(100vw-400px)] w-full h-96 flex justify-center items-center relative">
                ...
                <div class="relative z-10 w-full h-full">
                    <img src="{{asset('front')}}/images/post/post-1.jpg" alt="" class="w-full h-full object-cover absolute">
                </div>
                ...
                <div class="p-5 h-full overflow-y-auto flex-1">
                    ...
                    <div class="relative text-sm font-medium space-y-5"> 
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="{{asset('front')}}/images/avatars/avatar-2.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="{{asset('front')}}/images/avatars/avatar-3.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="{{asset('front')}}/images/avatars/avatar-7.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="{{asset('front')}}/images/avatars/avatar-4.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="{{asset('front')}}/images/avatars/avatar-5.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
