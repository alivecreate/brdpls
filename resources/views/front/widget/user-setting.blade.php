        ...
        <div class="box relative rounded-lg shadow-md">
            ...
            <div id="setting_tab" class="uk-switcher md:py-12 md:px-20 p-6 overflow-hidden text-black text-sm"> 
                            ...
                            <form class="needs-validation data-form"
                                ...
                                <div class="space-y-6 mt-8">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <input type="text" name="github" class="w-full" placeholder="http://www.github.com/myname">
                                        </div>
                                    </div>
                ...
                <div>
                    ...
                    <div>
                        {{-- @php
                        $security = getUserData()['id'];
                        @endphp
                        
                        <form class="needs-validation data-form" action="{{ route('security.update', $security) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put') --}}
                        <form class="needs-validation data-form" action="{{ route('security.store') }}" method="POST" enctype="multipart/form-data">
                             @csrf
                            <div class="space-y-6 max-w-lg mx-auto">
                                ...
                                <div class="md:flex items-center gap-16 justify-between">
                                    ...
                                    <div class="flex-1 max-md:mt-4">
                                        <select class="w-full !border-0 !rounded-md" name="authentication">
