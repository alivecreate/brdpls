                            ...
                            <ul class="uk-slider-items grid-small">
                                    ...
                                    <div class="card">
                                        <a href="{{route('video-watch')}}">
                                            <div class="card-media sm:aspect-[2/1.1] h-28">
                                                <img src="{{asset('front')}}/images/video/img-1.png" alt="">
                                        ...
                                        <div class="card-body">
                                            <a href="{{route('video-watch')}}">
                                                <h4 class="card-title text-sm line-clamp-2"> Amazing house construction from foundation to last detail</h4>
                                            </a>
                                            <p class="card-text mt-1.5"> <a href="{{route('timeline')}}"> 111 Jesse Steeve </a> </p>
                                ...
                                <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                    <div class="card">
                                        <a href="{{route('video-watch')}}">
                                            <div class="card-media sm:aspect-[2/1.1] h-28">
                                                <img src="{{asset('front')}}/images/video/img-2.png" alt="">
                                                <div class="card-overly"></div>
                                                <img src="{{asset('front')}}/images/icon-play.svg" class="!w-12 !h-12 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                                <span class="absolute bg-black bg-opacity-60 bottom-1 font-semibold px-1.5 py-0.5 right-1 rounded text-white text-xs z-10"> 12:21</span>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <a href="{{route('video-watch')}}">
                                                <h4 class="card-title text-sm line-clamp-2"> Great drone jet testing range flat model show with advance</h4>
                                            </a>
                                            <p class="card-text mt-1.5"> <a href="{{route('timeline')}}">  John Michael </a> </p>
                                            <div class="card-list-info text-xs mt-1 flex-wrap">
                                                <div> 27 weeks ago</div>
                                                <div class="md:block hidden">·</div>
                                                <div> 156.9K views</div>
                                ...
                                <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                    <div class="card">
                                        <a href="{{route('video-watch')}}">
                                            <div class="card-media sm:aspect-[2/1.1] h-28">
                                                <img src="{{asset('front')}}/images/video/img-3.png" alt="">
                                                <div class="card-overly"></div>
                                                <img src="{{asset('front')}}/images/icon-play.svg" class="!w-12 !h-12 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                                <span class="absolute bg-black bg-opacity-60 bottom-1 font-semibold px-1.5 py-0.5 right-1 rounded text-white text-xs z-10"> 12:21</span>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <a href="{{route('video-watch')}}">
                                                <h4 class="card-title text-sm line-clamp-2"> Exploring latest an abandoned water park in china city</h4>
                                            </a>
                                            <p class="card-text mt-1.5"> <a href="{{route('timeline')}}">  Monroe Parker </a> </p>
                                            <div class="card-list-info text-xs mt-1 flex-wrap">
                                                <div> 27 weeks ago</div>
                                                <div class="md:block hidden">·</div>
                                                <div> 156.9K views</div>
                                ...
                                <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                    <div class="card">
                                        <a href="{{route('video-watch')}}">
                                            <div class="card-media sm:aspect-[2/1.1] h-28">
                                                <img src="{{asset('front')}}/images/video/img-4.png" alt="">
                                                <div class="card-overly"></div>
                                                <img src="{{asset('front')}}/images/icon-play.svg" class="!w-12 !h-12 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                                <span class="absolute bg-black bg-opacity-60 bottom-1 font-semibold px-1.5 py-0.5 right-1 rounded text-white text-xs z-10"> 12:21</span>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <a href="{{route('video-watch')}}">
                                                <h4 class="card-title text-sm line-clamp-2"> cheese cake eggless without oven hida mari cooking </h4>
                                            </a>
                                            <p class="card-text mt-1.5"> <a href="{{route('timeline')}}">  Martin Gray </a> </p>
                                            <div class="card-list-info text-xs mt-1 flex-wrap">
                                                <div> 27 weeks ago</div>
                                                <div class="md:block hidden">·</div>
                                                <div> 156.9K views</div>
                                ...
                                <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                    <div class="card">
                                        <a href="{{route('video-watch')}}">
                                            <div class="card-media sm:aspect-[2/1.1] h-28">
                                                <img src="{{asset('front')}}/images/video/img-5.png" alt="">
                                                <div class="card-overly"></div>
                                                <img src="{{asset('front')}}/images/icon-play.svg" class="!w-12 !h-12 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                                <span class="absolute bg-black bg-opacity-60 bottom-1 font-semibold px-1.5 py-0.5 right-1 rounded text-white text-xs z-10"> 12:21</span>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <a href="{{route('video-watch')}}">
                                                <h4 class="card-title text-sm line-clamp-2"> Amazing little girl has very talent voice vocal coach</h4>
                                            </a>
                                            <p class="card-text mt-1.5"> <a href="{{route('timeline')}}">  James Lewis </a> </p>
                                            <div class="card-list-info text-xs mt-1 flex-wrap">
                                                <div> 27 weeks ago</div>
                                                <div class="md:block hidden">·</div>
                                                <div> 156.9K views</div>
                    ...
                    <div class="grid 2xl:grid-cols-5 lg:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-2.5 mt-10 hidden">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text mt-1.5"> <a href="{{route('timeline')}}">  Jesse Steeve </a> </p>
                                <div class="card-list-info text-xs mt-1 flex-wrap">
                                    <div> 27 weeks ago</div>
                                    <div class="md:block hidden">·</div>
                                    <div> 156.9K views</div>
                    ...
                    <div class="box p-6 mt-6">
                        ...
                        <div class="card-list">
                            ...
                            <div class="card-list-body relative">
                                <a href="{{route('video-watch')}}"> <h3 class="card-list-title lg:mt-2 lg:line-clamp-1">  Great drone jet testing range flat model show with advance  </h3> </a>
                                ...
                                <a href="{{route('timeline')}}"> <div class="card-list-link mt-5">   John Michael </div> </a>
                        ...
                        <div class="card-list">
                            ...
                            <div class="card-list-body relative">
                                <a href="{{route('video-watch')}}"> <h3 class="card-list-title lg:mt-2 lg:line-clamp-1">  Exploring latest an abandoned water park in china city</h3> </a>
                                <p class="card-list-text"> consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam,</p>
                                <a href="{{route('timeline')}}"> <div class="card-list-link mt-5">   Monroe Parker </div> </a>
                                <div class="flex items-center justify-between">
                                    <div class="card-list-info">
                                        <div> 27 weeks ago</div>
                                        <div class="md:block hidden">·</div>
                        ...
                        <div class="card-list">
                            ...
                            <div class="card-list-body relative">
                                <a href="{{route('video-watch')}}"> <h3 class="card-list-title lg:mt-2 lg:line-clamp-1">  cheese cake eggless without oven hida mari cooking </h3> </a>
                                <p class="card-list-text"> consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam,</p>
                                <a href="{{route('timeline')}}"> <div class="card-list-link mt-5">   Martin Gray </div> </a>
                                <div class="flex items-center justify-between">
                                    <div class="card-list-info">
                                        <div> 27 weeks ago</div>
                                        <div class="md:block hidden">·</div>
                        ...
                        <div class="card-list">
                            ...
                            <div class="card-list-body relative">
                                <a href="{{route('video-watch')}}"> <h3 class="card-list-title lg:mt-2 lg:line-clamp-1">  Amazing little girl has very talent voice vocal coach</h3> </a>
                                <p class="card-list-text"> consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam,</p>
                                <a href="{{route('timeline')}}"> <div class="card-list-link mt-5">   James Lewis </div> </a>
                                <div class="flex items-center justify-between">
                                    <div class="card-list-info">
                                        <div> 27 weeks ago</div>
                                        <div class="md:block hidden">·</div>
