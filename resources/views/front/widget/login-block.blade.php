...
<div class="sm:flex">
    ...
    <div class="relative lg:w-[580px] md:w-96 w-full p-10 min-h-screen bg-white shadow-xl flex items-center pt-10 dark:bg-slate-900 z-10">
      ...
      <div class="w-full lg:max-w-sm mx-auto space-y-10" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
        ...
        <!-- logo image-->
        <a href="#"> <img src="{{asset('front')}}/images/logo.png" class="w-28 absolute top-10 left-10 dark:hidden" alt=""></a>
        <a href="#"> <img src="{{asset('front')}}/images/logo-light.png" class="w-28 absolute top-10 left-10 hidden dark:!block" alt=""></a>
        ...
        <div>
          ...
          <p class="text-sm text-gray-700 font-normal">If you haven’t signed up yet. <a href="{{route('registration')}}" class="text-blue-700">Register here!</a></p>
        </div>
 

        <!-- form -->
        <form method="POST" action="{{route('checkAuth')}}" class="space-y-7 text-sm text-black font-medium dark:text-white"  uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true" enctype="multipart/form-data">
          ...
          <div>
              ...
              <div class="mt-2.5">
                <input id="phone" name="phone" type="tel" placeholder="Phone No." value="{{old('phone')}}" required class="w-full rounded-lg bg-transparent shadow-sm border border-slate-200 dark:border-slate-800 dark:bg-white/5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              </div>
          </div>
          <!-- password -->
          <div>
