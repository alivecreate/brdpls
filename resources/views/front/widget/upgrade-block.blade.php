                ...
                <ul class="-ml-2 uk-slider-items w-[calc(100%+10px)]">
                    ...
                    <li class="lg:w-1/3 w-1/2 pr-[10px]">
                        <label for="weekly">
                            ...
                            <div class="relative p-4 bg-white shadow -sm rounded-xl cursor-pointer peer-checked:[&_.active]:block dark:bg-dark3">
                                ...
                                <h2 class="text-3xl font-bold text-black relative px-2 dark:text-white"> <span class="text-sm absolute top-1.5 -left-1 font-normal text-gray-700">$</span> 12.99 </h2>
                    ...
                    <li class="lg:w-1/3 w-1/2 pr-[10px]">
                        <label for="monthly">
                            ...
                            <div class="relative p-4 bg-white shadow -sm rounded-xl cursor-pointer peer-checked:[&_.active]:block dark:bg-dark3 ring ring-blue-600 ring-offset-2 dark:ring-offset-slate-900">
                                <div class="mb-4 text-sm"> Monthly </div>
                                <h2 class="text-3xl font-bold text-black relative px-2 dark:text-white"> <span class="text-xs absolute top-1.5 -left-1 font-normal text-gray-400">$</span> 32.99 </h2>
                                <ion-icon name="checkmark-circle" class="hidden active absolute top-0 right-0 m-4 text-2xl text-blue-600 uk-animation-scale-up"></ion-icon>
                            </div>
                        </label>
                    </li> 
                    <li class="lg:w-1/3 w-1/2 pr-[10px]">
                        <label for="yearly">
                            ...
                            <div class="relative p-4 bg-white shadow -sm rounded-xl cursor-pointer peer-checked:[&_.active]:block dark:bg-dark3">
                                ...
                                <h2 class="text-3xl font-bold text-black relative px-2 dark:text-white"> <span class="text-xs absolute top-1.5 -left-1 font-normal text-gray-400">$</span> 62.99 </h2>
                                <ion-icon name="checkmark-circle" class="hidden active absolute top-0 right-0 m-4 text-2xl text-blue-600 uk-animation-scale-up"></ion-icon>
                            </div>
                        </label>
                    </li> 
                    <li class="lg:w-1/3 w-1/2 pr-[10px]">
                        <label for="forever">
                            <input type="radio" name="radio-membership" id="forever" class="peer appearance-none hidden" />
                            <div class="relative p-4 bg-white shadow -sm rounded-xl cursor-pointer peer-checked:[&_.active]:block dark:bg-dark3">
                                <div class="mb-4 text-sm"> Forever </div>
                                <h2 class="text-3xl font-bold text-black relative px-2 dark:text-white"> <span class="text-sm absolute top-1.5 -left-1 font-normal text-gray-700">$</span> 92.99 </h2>
                                <ion-icon name="checkmark-circle" class="hidden active absolute top-0 right-0 m-4 text-2xl text-blue-600 uk-animation-scale-up"></ion-icon>
                            </div>
                        </label>
                    </li> 
