            ...
            <div class="max-w-[1065px] mx-auto max-lg:-m-2.5">
                ...
                <div class="bg-white shadow lg:rounded-b-2xl lg:-mt-10 dark:bg-dark2">
                    ...
                    <div class="relative overflow-hidden w-full lg:h-72 h-48">
                        <img src="{{asset('front')}}/images/avatars/profile-cover.jpg" alt="" class="h-full w-full object-cover inset-0">
                    ...
                    <div class="p-3">
                        ...
                        <div class="flex flex-col justify-center md:items-center lg:-mt-48 -mt-28">
                            ...
                            <p class="mt-2 text-gray-500 dark:text-white/80"> Family , Food , Fashion , Fourever   <a href="#" class="text-blue-500 ml-4 inline-block"> Edit </a></p>
                        ...
                        <div class="lg:space-y-4 lg:pb-8 max-lg:grid sm:grid-cols-2 max-lg:gap-6" 
                            ...
                            <div class="box p-5 px-6">
                                ...
                                <div class="grid grid-cols-3 gap-2 gap-y-5 text-center text-sm mt-4 mb-2">
                                    ...
                                    <div>
                                        <div class="relative w-full aspect-square rounded-lg overflow-hidden">
                                            <img src="{{asset('front')}}/images/avatars/avatar-2.jpg" alt="" class="object-cover w-full h-full inset-0">
                                        </div> 
                                        <div class="mt-2 line-clamp-1"> John Michael </div>
                                    </div>
                                    <div>
                                        <div class="relative w-full aspect-square rounded-lg overflow-hidden">
                                            <img src="{{asset('front')}}/images/avatars/avatar-3.jpg" alt="" class="object-cover w-full h-full inset-0">
                                        </div> 
