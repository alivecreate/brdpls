                                    ...
                                    <ul class="-ml-2 uk-slider-items w-[calc(100%+0.5rem)] pt-3 text-center"  uk-scrollspy="target: > li; cls: uk-animation-scale-up; delay: 20 ;repeat: true">
                                            ...
                                            <a href="{{route('groupDetail')}}">
                                                <div class="relative">
                                                    <div class="card-media md:aspect-[2/1.8] max-lg:h-28 rounded-lg">
                                                        <img src="{{asset('front')}}/images/group/group-1.jpg" alt="">
                                        ...
                                        <li class="md:w-[14.28%] w-32 pr-3 pt-3">
                                            <a href="{{route('groupDetail')}}">
                                                <div class="relative">
                                                    <div class="card-media md:aspect-[2/1.8] max-lg:h-28 rounded-lg">
                                                        <img src="{{asset('front')}}/images/group/group-2.jpg" alt="">
                                                        <div class="card-overly"></div>
                                                    </div>
                                ...
                                <div class="grid md:grid-cols-3 grid-cols-2 gap-2.5" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 20 ;repeat: true">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body relative z-10">
                                            <img src="{{asset('front')}}/images/avatars/avatar-4.jpg" alt="" class="w-10 rounded-full mb-2 shadow md:-mt-11 -mt-7 relative border-2 border-white">
                                            <a href="{{route('groupDetail')}}"> <h4 class="card-title"> Delicious Foods  </h4></a>
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="{{route('groupDetail')}}"> <span> 218 Members </span> </a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card"> 
                                        ...
                                        <div class="card-body relative z-10">
                                            <img src="{{asset('front')}}/images/avatars/avatar-3.jpg" alt="" class="w-10 rounded-full mb-2 shadow md:-mt-11 -mt-7 relative border-2 border-white">
                                            <a href="{{route('groupDetail')}}"> <h4 class="card-title"> Abstract minimal </h4></a>
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="{{route('groupDetail')}}"> <span> 218 Members </span> </a> 
                                                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body relative z-10">
                                            <img src="{{asset('front')}}/images/avatars/avatar-2.jpg" alt="" class="w-10 rounded-full mb-2 shadow md:-mt-11 -mt-7 relative border-2 border-white">
                                            <a href="{{route('groupDetail')}}"> <h4 class="card-title"> Delicious Foods  </h4></a>
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="{{route('groupDetail')}}"> <span> 164 Members </span> </a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body relative z-10">
                                            ...
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="{{route('groupDetail')}}"> <span> 325 Members</span> </a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-body relative z-10">
                                            <img src="{{asset('front')}}/images/avatars/avatar-5.jpg" alt="" class="w-10 rounded-full mb-2 shadow md:-mt-11 -mt-7 relative border-2 border-white">
                                            <a href="{{route('groupDetail')}}"> <h4 class="card-title"> Property Rent </h4></a>
                                        
                                            <div class="card-text mt-1">
                                                
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="{{route('groupDetail')}}"> <span> 158 Members </span> </a> 
                                                </div>
                            ...
                            <div>
                                ...
                                <div class="grid md:grid-cols-3 grid-cols-2 gap-2.5" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 20 ;repeat: true">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body relative z-10">
                                            <a href="{{route('groupDetail')}}"> <h4 class="card-title">  Graphic Design </h4>  </a>                            
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
