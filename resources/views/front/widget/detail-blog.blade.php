        ...
        <main id="site__main" class="2xl:ml-[--w-side]  xl:ml-[--w-side-sm] py-10 p-2.5 h-[calc(100vh-var(--m-top))] mt-[--m-top]">
            ...
            <div class="flex 2xl:gap-12 max-lg:flex-col gap-10 2xl:max-w-[1220px] max-w-[1065px] mx-auto lg:mt-2 mt-6" id="js-oversized">
                ...
                <div class="flex-1">
                    ...
                    <div class="box overflow-hidden">
                        ...
                        <div class="relative h-80">
                            ...
                            <img src="{{asset('front')}}/images/blog/img-5.jpg" class="h-36 mb-4 w-full h-full object-cover">
    
                            <!-- optional -->
                            <div class="p-6 w-full z-10 absolute bg-gradient-to-t bottom-0 from-black/60 hidden">
                                <h1 class="text-xl font-semibold !text-white"> How designers estimate the impact of UX? </h1>
            
                                <div class="flex items-center gap-5 mt-4 !text-white">
                                    <div class="w-6 h-6 flex-shrink-0 rounded-md relative"> 
                                        <img src="{{asset('front')}}/images/avatars/avatar-7.jpg" class="absolute w-full h-full inset-0 rounded-full object-cover" alt="">
                                    </div>
                                    <div class="flex-1">
                                    ...
                                    <div class="text-sm ml-auto text-gray-400"> November 1, 2022 </div>
                                </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex gap-3 text-sm mt-6">
                                <img src="{{asset('front')}}/images/avatars/avatar-5.jpg" alt="" class="w-9 h-9 rounded-full">
                                <div class="flex-1">
