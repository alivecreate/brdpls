...
<div class="sm:flex login-page-wrapper">
    ...
    <div
        class="relative lg:w-[580px] md:w-96 w-full p-10 min-h-screen bg-white shadow-xl flex items-center pt-10 dark:bg-slate-900 z-10 dark:text-white">
        ...
        <div class="w-full lg:max-w-sm mx-auto space-y-10 m-responsive"
            ...
            <div>
                ...
                <p class="text-md font-semibold mt-6 mb-4">ગણેશ સ્પર્ધામાં ભાગ લેવા અને વોટિંગ કરવા અકાઉંટ બનાવવું
                    ફરજિયાત છે.</p>
            ...
            <!-- form -->
            <form class="needs-validation data-form" action="{{route('users.store')}}" method="POST"
                ...
                <div class="grid grid-cols-2 gap-4 gap-y-7">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="mt-2.5">
                            <input id="text" name="first_name" type="text" autofocus="" value="{{old('first_name')}}"
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="mt-2.5">
                            <input id="text" name="last_name" type="text" value="{{old('last_name')}}"
