    ...
    <div class="w-full md:w-auto md:px-20">
                        ...
                        <div class="relative" tabindex="-1" uk-slider="auto play: true;finite: true">
                            <div class="py-5 uk-slider-container">
                                ...
                                <li class="pr-3 md:w-1/5 w-auto" uk-scrollspy-class="uk-animation-fade">
                                        <div class="p-4 flex gap-3 h-36 justify-between bg-sky-600 rounded-md">
                                            <div class='color-block-item'>
                                                <h4 class="font-medium !text-white whitespace-nowrap"> AC Repairing </h4>
                                                <p  class="font-medium !text-white/80 text-sm mt-1 whitespace-nowrap"> 14 product </p>
                                                <a href="#" class='bg-white py-2 text-center rounded-full shadow-md font-semibold text-xs dark:bg-dark2'>Read More</a>
                                            
                                            </div>
                                            ,<img class='img-thumb-category' src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/hkim_acrepair.png?w=256&q=75" alt="">
                                        </div>
                                    </li>
                                    
                                    <li class="pr-3 md:w-1/5 w-auto" uk-scrollspy-class="uk-animation-fade">
                                        <div class="p-4 flex gap-3 h-36 item-center justify-between bg-rose-500 rounded-md">
                                            <div class='color-block-item'>
                                                <h4 class="font-medium !text-white whitespace-nowrap"> Real Estate </h4>
                                                <p  class="font-medium !text-white/80 text-sm mt-1 whitespace-nowrap"> 14 product </p>
                                                <a href="#" class='bg-white py-2 text-center rounded-full shadow-md font-semibold text-xs dark:bg-dark2'>Read More</a>
                                            
                                            </div>
                                            ,<img class='img-thumb-category' src="https://akm-img-a-in.tosshub.com/businesstoday/images/story/201908/house_prop_660_080719010504.jpg" alt="">
                                        </div>
                                    </li>
                                    
                                    <li class="pr-3 md:w-1/5 w-auto" uk-scrollspy-class="uk-animation-fade">
                                        <div class="p-4 flex gap-3 h-36 item-center justify-between bg-teal-600 rounded-md">
                                            <div class='color-block-item'>
                                                <h4 class="font-medium !text-white whitespace-nowrap"> Hospitals </h4>
                                                <p  class="font-medium !text-white/80 text-sm mt-1 whitespace-nowrap"> 14 product </p>
                                                <a href="#" class='bg-white py-2 text-center rounded-full shadow-md font-semibold text-xs dark:bg-dark2'>Read More</a>
                                    ...
                                    <li class="pr-3 md:w-1/5 w-auto" uk-scrollspy-class="uk-animation-fade">
                                        <div class="p-4 flex gap-3 h-36 item-center justify-between bg-sky-600 rounded-md">
                                            <div class='color-block-item'>
                                                <h4 class="font-medium !text-white whitespace-nowrap"> Education </h4>
                                                <p  class="font-medium !text-white/80 text-sm mt-1 whitespace-nowrap"> 14 product </p>
                                                <a href="#" class='bg-white py-2 text-center rounded-full shadow-md font-semibold text-xs dark:bg-dark2'>Read More</a>
                                    ...
                                    <li class="pr-3 md:w-1/5 w-auto" uk-scrollspy-class="uk-animation-fade">
                                        <div class="p-4 flex gap-3 h-36 item-center justify-between bg-pink-600 rounded-md">
                                            <div class='color-block-item'>
                                                <h4 class="font-medium !text-white whitespace-nowrap"> Sports </h4>
                                                <p  class="font-medium !text-white/80 text-sm mt-1 whitespace-nowrap"> 14 product </p>
                                                <a href="#" class='bg-white py-2 text-center rounded-full shadow-md font-semibold text-xs dark:bg-dark2'>Read More</a>
        ...
        <!-- group  slider -->
        <div tabindex="-1" uk-slider="finite:false">
            ...
            <div class="uk-slider-container pb-1">
                ...
                <ul class="uk-slider-items grid-small">
                    ...
                    <li class="md:w-1/5 sm:w-1/3 w-1/2">
                        <a href="#"> 
                            <div class="relative rounded-lg overflow-hidden">
                                <img src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/hkim_beautyparlour.png?w=256&q=75" alt="" class="h-36 w-full object-cover">
                                <div class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                    <div class="text-white p-5 text-lg leading-3"> Beauty </div>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li class="md:w-1/5 sm:w-1/3 w-1/2">
                        <a href="#">  
                            <div class="relative rounded-lg overflow-hidden">
                                <img src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/hkim_carservice.png?w=256&q=75" alt="" class="h-36 w-full object-cover">
                                <div class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                    <div class="text-white p-5 text-lg leading-3"> Car Repairing </div>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li class="md:w-1/5 sm:w-1/3 w-1/2">
                        <a href="#"> 
                            <div class="relative rounded-lg overflow-hidden">
                                <img src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/hkim_acrepair.png?w=256&q=75" alt="" class="h-36 w-full object-cover">
                                <div class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                    <div class="text-white p-5 text-lg leading-3"> AC </div>
                                </div>
                            </div>
                        </a>
                    </li>
