                        ...
                        <div>
                            <div class="flex items-center gap-2 mt-1">
                                ...
                                <button
                                    ...
                                    <a
                                        href="@if($group->user_id == Auth::id()){{route('ganeshFestivalCompetition.create', ['type'=>'group'])}}@else # @endif">
                                        <span class="text-sm">
            ...
            <div class="lg:w-[400px] lg:hidden w-full">
                ...
                <div class="lg:space-y-4 lg:pb-8 max-lg:grid sm:grid-cols-2 max-lg:gap-6"
                    ...
                    <div class="box p-5 px-6">
                        ...
                        <div class="flex-center mb-4">
                            <h2 class="heading-h2 text-danger text-underline">ગણેશ સ્પર્ધા-2024 ની બધી વોટિંગ લાઇન બંધ
                                કરી દેવામાં આવેલ છે.</h2>
                        </div>
