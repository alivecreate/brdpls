...
@section('content')
    ...
    <div class="lg:flex 2xl:gap-12 gap-10 2xl:max-w-[1220px] max-w-[1065px] mx-auto lg:mt-2 mt-6">
        <div class="2xl:w-[380px] lg:w-[330px] w-full">
            ...
            <h1 class="heading-h1">List Business in just <span>365</span></h1>
        ...
        <div class="w-3/5 bg-white p-4">
            ...
            <p class='heading-h1 font-semibold text-black font-semibold text-black mb-5'>Enter your business detail</p>
                       ...
                       @csrf
                        ...
                        <div class="md:flex items-center gap-10">
                            ...
                            <div class="md:flex items-center gap-10">
                                <div class="flex-1 max-md:mt-4">
                                    <input type="text" name="building" placeholder="Building / apartment Name" class="w-full">
                                </div>
                            </div>

                            <div class="md:flex items-center gap-10">
                                <div class="flex-1 max-md:mt-4">
                                    <input type="text" name="street" placeholder="Street / Lane" class="w-full">
                                </div>
                            </div>
