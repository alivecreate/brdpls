...
<main id="site__main" class="w-full py-10 p-2.5 h-[calc(100vh-var(--m-top))] mt-[--m-top]">
    ...
    <div class='business-info-b text-center'>
        <h2 class="font-semibold text-underline justify-center">Choose Business Category 
                <span>(Compeleted)
                </span></h2>
    </div>
    ...
    <div class="lg:flex mx-auto lg:mt-2 mt-6 justify-center" id="js-oversized">
            ...
            <form class="needs-validation data-form" action="{{route('storeStep4BusinessCategory')}}" method="POST"
                ...
                <div id="search--box" class="sm:w-96 sm:relative rounded-mdoverflow-hidden z-20 left-0 bg-white">
                    ...
                    <input type="text" placeholder="Search Category"
                        class="w-full search-bar !pl-10 !font-normal !bg-transparent h-12 !text-sm" id="search-input">
                </div>
