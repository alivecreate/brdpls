...
<div class="hidden uk-open z-10" id="search-dropdown">
    <div class="sm:w-96 bg-white dark:bg-dark3 w-screen p-2 rounded-lg shadow-lg -mt-14 pt-14">
            ...
            <a href="#" class="flex hover:bg-red-50 dark:hover:bg-slate-700 p-1.5 rounded"> <ion-icon name="trash" class="mr-2 text-lg"></ion-icon> Clear your history</a> 
                    ...
                    $(document).ready(function() {
                        ...
                        $(document).on('click', '.result-item', function() {
                            ...
                            const selectedItem = `
            <li id="selected-${id}" class="selected-item flex justify-between items-center py-1">
        ...
        `;
                    ...
                    //                     data.results.forEach(function(item) {
                    //                         const resultItem = `
                    //                             <a href="#" class="result-item relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10" data-id="${item.id}" data-name="${item.name}" data-img="${item.img}" data-type="${item.type}">
                    //                                 <img src="${item.img}" class="w-9 h-9 rounded-full">
                    //                                 <div>
                    //                                     <div>${item.name}</div>
                    ...
                    //         const selectedItem = `
                    //             <li id="selected-${id}" onClick=`${removeSelectedselected('selected-'{id})}` class="flex justify-between items-center py-1">
                    //                 <div class="flex items-center gap-4">
                    //                     <div>
                    //                         <div>${name}</div>
                    //                     </div>
