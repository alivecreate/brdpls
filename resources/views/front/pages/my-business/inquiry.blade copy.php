...
<!-- main contents -->
<main id="site__main" class="p-2.5 h-[calc(100vh-var(--m-top))] mt-10">
                                ...
                                <div class=''>
                                    ...
                                    <div class="w-[240px]"
                                        ...
                                        <nav>
                                            ...
                                            <a href="#" class="delete-button text-danger" data-cid="{{$business->cid}}"
                                                data-name="{{$business->name}}"
                                                uk-toggle="target: #confirm-delete-mybusiness-popup">
