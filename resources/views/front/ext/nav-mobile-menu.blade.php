...
<div class="p-3 uk-slider-container mt-6 nav-mobile-menu lg:hidden">
        ...
        @if(!isGroupExists() && !isHomeCompetitionExists())
            ...
            <a href="{{route('ganeshFestivalCompetition.create')}}" 
            class="flex-inline p-3 px-4 rounded-lg bg-purple-100/60 text-purple-600 font-semibold dark:text-white dark:bg-dark4">
        ...
        <a href="{{route('GaneshFestivalCompetitionRules')}}" 
            class="flex-inline p-3 px-4 rounded-lg bg-purple-100/60 text-purple-600 dark:text-white dark:bg-dark4">
